  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      timeline
        ...
        .from('.editorial-card', { opacity: 0, y: 18, duration: 0.9 }, '-=0.35')
        ...
        .from('.scene-note', { opacity: 0, y: 8, duration: 0.55 }, '-=0.3')
        .from('.detail-rail', { opacity: 0, y: 16, duration: 0.8 }, '-=0.35')
    }, root)
    ...
    <div ref={root} className="app-shell">
      ...
      <main id="top">
            ...
            <div className="panel-content">
              ...
              <div className="panel-grid">
                <div className="panel-copy">
                  <p className="eyebrow copy-reveal">Sculptural digital habitat</p>
                  <h1 id="hero-title" className="copy-reveal">A small world, carefully composed.</h1>
                  <p className="panel-description copy-reveal">
                    A browser-rendered miniature landscape built around quiet materials,
                    soft architecture and a deliberately restrained sense of depth.
                  </p>
                </div>

                <div className="panel-side copy-reveal">
                  <span className="side-number">01</span>
                  <p>Move gently across the scene.</p>
        ...
        <section className="notes-section" id="notes" aria-labelledby="notes-title">
          ...
          <p>
            The composition now prioritizes scale, silhouette, material softness and negative space.
